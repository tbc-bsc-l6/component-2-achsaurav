    ...
    <div class="md:max-w-[60%] md:m-auto md:text-[.9em] " >
        ...
        <form action="/admin/posts" method="post" >
            ...
            <fieldset class="mb-[30px] border-none ">
                ...
                <div class="md:flex">
                    <input required type="text" value="{{old('title')}}" class="md:flex-[2_550px] md:max-w-[80%] text-[16px] w-[80%] rounded-[5px] shadow-[0_1px_0_rgba(0,0,0,0.03)] h-auto m-0 outline-0 p-[15px] mb-[30px] border-none opacity-50 focus:border-[2px] focus:border-solid focus:border-black opacity-100" id="title" name="title" placeholder="title">
                    @error('title')
                        <p class="text-red-500 text-[18px] mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:flex">
                    <input required type="text" value="{{old('price')}}" class="md:flex-[2_550px] md:max-w-[80%] text-[16px] w-[80%] rounded-[5px] shadow-[0_1px_0_rgba(0,0,0,0.03)] h-auto m-0 outline-0 p-[15px] mb-[30px] border-none opacity-50 focus:border-[2px] focus:border-solid focus:border-black opacity-100" id="price" name="price" placeholder="Price">
                    @error('price')
                        <p class="text-red-500 text-[18px] mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:flex">
                    <input required type="text" value="{{old('pages')}}" class="md:flex-[2_550px] md:max-w-[80%] text-[16px] w-[80%] rounded-[5px] shadow-[0_1px_0_rgba(0,0,0,0.03)] h-auto m-0 outline-0 p-[15px] mb-[30px] border-none opacity-50 focus:border-[2px] focus:border-solid focus:border-black opacity-100" id="pages" name="pages" placeholder="pages/ payLength/ PEGI">
                    @error('pages')
                        <p class="text-red-500 text-[18px] mt-1">{{ $message }}</p>
                    @enderror
                </div>
