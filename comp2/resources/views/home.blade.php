    ...
    <section class="lg:p-[2rem] p-[2rem_9%]" id="review">
        ...
        <div class="flex flex-wrap gap-[1.5rem]">
            ...
            <div
                ...
                <h3 class="text-[2.5rem] text-[#2c2c54]">Php Fundamentals</h3>
                <h5 class="text-[2rem]">Tom Brew</h5>
                
                    <p class="text-[1.6rem] text-[#666] p-[1rem_0] "><span>Category:</span><a href="#" class="hover:text-blue-600 underline hover:italic">BOOK</a></p>
                
                <p class="text-[1.6rem] text-[#666] p-[1rem_0]">Price: $110</p>
                <p class="text-[1.6rem] text-[#666] p-[1rem_0]">Number of pages: 45</p>
